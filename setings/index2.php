...
$result = mysql_query("SELECT COUNT(*) FROM $db_table_adver");
...
$result = mysql_query("SELECT a.advert_id, u.user_name, a.title FROM $db_table_adver a NATURAL JOIN $db_table_user u ORDER BY advert_id DESC LIMIT $start, $num");
